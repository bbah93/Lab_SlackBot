...
1. Each team member create a new branch in your forked Lab_SlackBot repo named after you to identify their work. Each commmit should be short be descriptive enough to hint at the work you've done. When you finish each feature, add, commit and push your changes. On GitHub, open a new Pull Request and assign it to your teammate to review and merge.
